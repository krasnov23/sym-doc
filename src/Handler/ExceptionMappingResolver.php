...
{
    /**
     * @var ExceptionMappingModel[]
     */
    private array $mappings = [];

    public function __construct(array $mappings)
    {
        // class : App\Exceptions\TripNotFoundException , mapping: { code: 404, hidden: false, loggable: false }
    ...
    public function resolve(string $throwableClass): ?ExceptionMappingModel
    {
        $foundMapping = null;
    ...
    {
        $this->mappings[$class] = new ExceptionMappingModel($code,$hidden,$loggable);
    }
}